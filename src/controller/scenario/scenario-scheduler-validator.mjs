...
export class ScenarioSchedulerValidator {
    ...
    listScenarioSchedulersValidator() {
        return [
            ...
            query('filter.updatedBefore', 'The valid must be a date.').optional().isISO8601({ strict: true }),
            query('filter.updatedAfter', 'The valid must be a date.').optional().isISO8601({ strict: true }),
